...
_FINAL_GENERATED_PPTX_CONTRACTS: dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "thesis-deck-system/artifacts/phase3/planner-composition-candidate-review.pptx": ("planner_composition_review_deck", "presentation-planner-application-builder", ("packages/thesis-deck-system/src/thesis_deck_system/presentation_planner_application.py", "packages/thesis-deck-system/src/thesis_deck_system/research_visual_acceptance.py", "packages/thesis-deck-system/src/thesis_deck_system/pptx.py", "packages/thesis-deck-system/src/thesis_deck_system/template.py", "thesis-deck-system/artifacts/phase3/real-research-visual-fixture-pack.json", "thesis-deck-system/artifacts/phase3/real-research-visual-review-application.json", "thesis-deck-system/artifacts/phase3/real-research-physical-composition-plans.json", "thesis-deck-system/artifacts/phase3/professor-visual-review-manifest.json")),
}
