...
def compile_slide(block_id: str, stage: str, recipe: str, source_cursor: int, *, revision: int = 1, content: dict | None = None, asset_path: str | None = None) -> dict:
    ...
    content = content or {}
    placement = {"slot": "hero_visual", "asset_id": "A001"}
    ...
    return {
        ...
        "bindings": {"claim_refs": content.get("claim_refs", ["C001"]), "evidence_refs": content.get("evidence_refs", ["E001"]), "asset_refs": ["A001"], "action_refs": ["NS001"], "professor_profile_ref": {"profile_id": "PROF-SYNTH-001", "version": "1.0.0"}, "template_profile_ref": {"profile_id": "TP-SYNTH-001", "version": "1.0.0"}},
        "content": content,
    }
